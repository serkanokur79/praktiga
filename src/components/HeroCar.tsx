...
const HeroCareerSection = () => {
    ...
    return (
        <div className="relative h-[26rem] overflow-hidden w-full">
            <video
                autoPlay
                loop
                muted
            ...
            <div className="relative z-20 flex flex-col  h-1/2 px-4 text-center text-white dark:text-gray-400 mt-[16rem]">
