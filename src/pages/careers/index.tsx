                ...
                <div className="py-4 bg-transparent">
                    <div className=" mx-auto text-center">
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div className="bg-transparent p-4 rounded-lg shadow-lg">
                                <Image src="/images/image2.jpg" alt="Career" className="w-full h-24 md:h-48 object-cover rounded-t-lg mb-4" width={600} height={600} />
                            ...
                            <div className="bg-transparent p-4 rounded-lg shadow-lg">
                                <Image src="/images/image3.jpg" alt="Well Being" className="w-full h-24 md:h-48 object-cover rounded-t-lg mb-4" width={600} height={600} />
                            ...
                            <div className="bg-transparent p-4 rounded-lg shadow-lg">
                                <Image src="/images/image4.jpg" alt="Company Culture" className="w-full h-24 md:h-48 object-cover rounded-t-lg mb-4" width={600} height={600} />
